        ...
        do: (params) => {
            ...
            if (user.name === 'admin') {
                userInfo = {
                    ...
                    groups: [{ name: 'root' }],
                    authInfos: [
                        { authType: 'github', authId: 'admin_github' },
                        { authType: 'wechat', authId: 'admin_wechat' }
                    ]
                };
                ...
                userInfo = {
                    name: 'doctor',
                    id: 2,
                    email: 'doctor@weave.com',
                    createdAt: '2023-05-11T01:38:23.500389Z',
                    groups: [{ name: 'doctor' }],
                    authInfos: [
                        { authType: 'github', authId: 'doctor_github' }
                    ]
                };
                ...
                userInfo = {
                    name: 'patient',
                    id: 3,
                    email: 'patient@weave.com',
                    createdAt: '2023-05-11T01:38:23.500389Z',
                    groups: [{ name: 'patient' }],
                    authInfos: [
                        { authType: 'wechat', authId: 'patient_wechat' }
                    ]
                };
            } else {
                userInfo = {
